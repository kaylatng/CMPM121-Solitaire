...
function FoundationPile:updateCardPositions()
  for i, card in ipairs(self.cards) do
...
function TableauPile:updateCardPositions()
  for i, card in ipairs(self.cards) do
...
function StockPile:updateCardPositions()
  for i, card in ipairs(self.cards) do
    card.targetPosition = Vector(self.position.x, self.position.y)
    card.faceUp = false
  end
...
function WastePile:updateCardPositions()
